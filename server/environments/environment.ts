...
class Environment implements IEnvironment {
  ...
  public secretKey: string | any;

  public secretAccessToken: string | any;

  public applyEncryption: any;
  ...
  constructor(NODE_ENV?: string) {
    ...
    this.applyEncryption = false;
    this.secretKey = process.env.SECRET_KEY;
    this.secretAccessToken = process.env.SECRET_ACCESS_TOKEN;
  }
