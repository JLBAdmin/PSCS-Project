...
export const colModel = [
  {
    ...
    formatoptions: {
      ...
      delbutton: true, // แสดงปุ่มลบ
      editbutton: true // แสดงปุ่มแก้ไข
  ...
  },
  {
    ...
    edittype: 'select',
    editoptions: {
      value: '00:รออนุมัติ;01:อนุมัติแล้ว;02:ไม่พิจจารณา;03:ยกเลิก',
      defaultValue: '00'
    },
    stype: 'select',
    searchoptions: {
      sopt: ['eq', 'ne'],
      value: ':Any;00:รออนุมัติ;01:อนุมัติแล้ว;02:ไม่พิจจารณา;03:ยกเลิก'
    }
  },
  {
    name: 'budget_status',
