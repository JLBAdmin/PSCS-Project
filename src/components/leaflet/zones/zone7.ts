...
export const plotZone7 = L.geoJSON(null || undefined, {
  style: plotStyle,
  ...
  filter(feature: any): boolean {
    return feature.properties.zone === '7';
  }
});

export const pointSubZone701: any = L.geoJSON(null || undefined, {
  onEachFeature(feature: any, layer) {
    const content =
      `<table class='tbl'>` +
  ...
  filter(feature: any) {
    return feature.properties.isSubvZone === 701;
  },
  pointToLayer(_feature, latLng) {
    return L.marker(latLng, {
      icon: L.icon({
        iconUrl:
          '/assets/images/mapiconscollection-numbers-0b79b8-iphone/number_71.png',
        iconSize: [28, 28],
        iconAnchor: [12, 28],
        popupAnchor: [0, -25]
      })
...
export const pointSubZone702: any = L.geoJSON(null || undefined, {
  onEachFeature(feature: any, layer) {
    const content =
      `<table class='tbl'>` +
      `<tr><th>รหัสแปลง</th><td>${feature.properties.myGis}</td></tr>` +
  ...
  filter(feature: any) {
    return feature.properties.isSubvZone === 702;
  },
  pointToLayer(_feature, latLng) {
    return L.marker(latLng, {
      icon: L.icon({
        iconUrl:
          '/assets/images/mapiconscollection-numbers-0b79b8-iphone/number_72.png',
        iconSize: [28, 28],
        iconAnchor: [12, 28],
        popupAnchor: [0, -25]
      })
...
export const zone701Lable: any = L.geoJSON(null || undefined, {
  filter(feature: any) {
    return feature.properties.isSubvZone === 701;
  },
...
export const zone702Lable: any = L.geoJSON(null || undefined, {
  filter(feature: any) {
    return feature.properties.isSubvZone === 702;
  },
  pointToLayer(feature: any, latLng) {
