...
export const plotZone14 = L.geoJSON(null || undefined, {
  style: plotStyle,
  ...
  filter(feature: any): boolean {
    return feature.properties.zone === '14';
  }
});

export const pointSubZone1401: any = L.geoJSON(null || undefined, {
  onEachFeature(feature: any, layer) {
    const content =
      `<table class='tbl'>` +
  ...
  filter(feature: any) {
    return feature.properties.isSubvZone === 1401;
  },
  pointToLayer(_feature, latLng) {
    return L.marker(latLng, {
      icon: L.icon({
        iconUrl:
          '/assets/images/mapiconscollection-numbers-0b79b8-iphone/number_141.png',
        iconSize: [28, 28],
        iconAnchor: [12, 28],
        popupAnchor: [0, -25]
      })
...
export const pointSubZone1402: any = L.geoJSON(null || undefined, {
  onEachFeature(feature: any, layer) {
    const content =
      `<table class='tbl'>` +
      `<tr><th>รหัสแปลง</th><td>${feature.properties.myGis}</td></tr>` +
  ...
  filter(feature: any) {
    return feature.properties.isSubvZone === 1402;
  },
  pointToLayer(_feature, latLng) {
    return L.marker(latLng, {
      icon: L.icon({
        iconUrl:
          '/assets/images/mapiconscollection-numbers-0b79b8-iphone/number_142.png',
        iconSize: [28, 28],
        iconAnchor: [12, 28],
        popupAnchor: [0, -25]
      })
...
export const zone1401Lable: any = L.geoJSON(null || undefined, {
  filter(feature: any) {
    return feature.properties.isSubvZone === 1401;
  },
...
export const zone1402Lable: any = L.geoJSON(null || undefined, {
  filter(feature: any) {
    return feature.properties.isSubvZone === 1402;
  },
  pointToLayer(feature: any, latLng) {
