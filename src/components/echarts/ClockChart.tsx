...
const ClockChart = () => {
  ...
  const clockPS = () => {
    const chartDom: any = document.getElementById('Clock');
    ...
    const timeUpdatedStatus: any = {
      second: false,
      minute: false,
      hour: false
    };

    function updateSeries(time: number, series: any, type: string) {
      const isCritical =
  ...
  return (
    <div>
      ...
      <div id='Clock' style={{ width: '90vw', height: '80vh' }} />
      {/* </div> */}
    </div>
  );
};
