...
const BudgetChart2 = ({ isCaption, isManag, isStyle, isLable }: any) => {
  useEffect(() => {
  ...
  const clockPS = () => {
    ...
    app.config = {
      rotate: 70, // ปรับต้วอักษร ตรงหรือเอียง
      align: 'left',
      ...
      series: [
        {
          ...
          data: [210000, 260000, 300000, 340000, 380000, 300]
        },
        {
          name: 'พื่นที่เสียหาย',
          type: 'bar',
