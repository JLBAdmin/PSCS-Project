...
import {
  colModel,
  colName
} from '@/components/grid-headers/budget.header.prove';
...
const Budgets = dynamic(() => import('@/components/grid-tables/grid-master2'), {
  ssr: false
});
...
const Budget: NextPage = () => {
  ...
  const { data, error } = useSWR([`/api/budget/all`, token], fetcher, {
    refreshInterval: 0
  });
