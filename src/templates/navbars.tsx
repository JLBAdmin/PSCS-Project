              ...
              <div className='menu animated faster absolute right-0 z-20 mt-5 hidden w-40 rounded bg-white py-2 text-gray-500 shadow-md xl:mt-10 xl:w-full'>
                <Link href='/admins/target'>
                  <a className='block bg-white px-3 py-2 text-sm font-medium capitalize tracking-wide transition-all duration-300 ease-in-out hover:bg-gray-200 hover:text-gray-900'>
                    <i className='fa fa-pencil-square mr-1 text-xs'></i>
                    เป้าหมายส่งเสริม
                  </a>
                </Link>
                <Link href='/admins/targetCane'>
                  <a className='block bg-white px-3 py-2 text-sm font-medium capitalize tracking-wide transition-all duration-300 ease-in-out hover:bg-gray-200 hover:text-gray-900'>
                    <i className='fa fa-pencil-square mr-1 text-xs'></i>
                    เป้าหมายเข้าหีบ
                  </a>
                </Link>
                <Link href='/admins/hourCane'>
                  <a className='block bg-white px-3 py-2 text-sm font-medium capitalize tracking-wide transition-all duration-300 ease-in-out hover:bg-gray-200 hover:text-gray-900'>
                    <i className='fa fa-pencil-square mr-1 text-xs'></i>
                    เข้าหีบประจำวัน
                  </a>
                </Link>
                <Link href='/admins/dashboard/factory'>
                  <a className='block bg-white px-3 py-2 text-sm font-medium capitalize tracking-wide transition-all duration-300 ease-in-out hover:bg-gray-200 hover:text-gray-900'>
                    <i className='fa fa-inbox mr-1 text-xs'></i>
                    อ้อยเข้าหีบโรงงาน
                  </a>
                </Link>

                <Link href='/admins/company'>
                  <a className='block bg-white px-3 py-2 text-sm font-medium capitalize tracking-wide transition-all duration-300 ease-in-out hover:bg-gray-200 hover:text-gray-900'>
                    <i className='fa fa-certificate mr-1 text-xs'></i>
                    โรงานน้ำตาล
                  </a>
                </Link>
